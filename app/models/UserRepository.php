...
{
    /**
     * Update an existing account with the given parameters
     *
     * @param  array $input Array containing 'first_name', 'last_name', 'username', 'email' and 'password'.
     *
    ...
    public function update($input, $id)
    {
        ...
        $user->is_physician = array_get($input, 'is_physician');
